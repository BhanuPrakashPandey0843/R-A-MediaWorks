...
import blogHeroImage from "@/assets/blog_hero.png";
...
/**
 * Blog page hero — sibling of the Home Hero. Same structure, spacing,
    ...
    >
      ...
      <Container className="relative grid items-center gap-16 lg:grid-cols-[1fr_1.08fr] lg:gap-14">
        <div>
          ...
          >
            Strategy notes, behind-the-scenes thinking, and the occasional
            strong opinion on branding, marketing, and the craft of being
            heard.
          </motion.p>
          ...
          >
            Written with the same newsroom discipline we bring to client
            work — clear, considered, and worth the read.
          </motion.p>
        ...
        >
          ...
          >
            <Image
              src={blogHeroImage}
              alt="Editorial illustration for the R&A MediaWorks blog"
              preload
